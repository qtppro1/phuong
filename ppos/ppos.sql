...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 13, 2021 lúc 06:51 PM
...
(5, 'Bao da', 'Sản phẩm đóng gói', '2021-07-13 09:47:42', '2021-07-13 09:47:42');
...
(1, 1, 1, 'Iphone 6s 64GB', 132, 'media.jpg', 2300000, 2500000, 'Sản phẩm đến từ nhà táo', 'Còn hàng', '2021-07-13 09:51:12', '2021-07-13 09:51:12');
...
INSERT INTO `users` (`id`, `maquyen`, `hoten`, `diachi`, `gioitinh`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(2, 2, 'phan phu thuan', 'can tho', 'Nam', 'thuan@gmail.com', NULL, '$2y$10$JoTqKr/CmVv4GtiaXsjRQ.A0hCpSJozL6XP7ah.2hedlujfiNfzgW', NULL, '2021-07-13 07:56:02', '2021-07-13 07:56:02');
